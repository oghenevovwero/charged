  ...
  return (
    <div className="bg-black flex justify-center items-center py-36 px-2 sm:px-4 md:px-14 lg:px-48 xl:px-64">
      <div className="flex flex-col md:flex-row md:h-96">
        <div className="flex-1 bg-[#54645D] text-white rounded-3xl md:rounded-l-3xl flex flex-col p-14 justify-center items-center">
          <div className="font-bold text-3xl">Join the WaitList</div>
          ...
          <div className="w-full relative">
            ...
            />
            <button className="bg-[#00A63D] absolute right-1 top-[3px] hover:cursor-pointer hover:bg-[#2f794a] text-white px-3 py-3 rounded-md text-sm font-light">
              Join waitlist
            </button>
          </div>
        </div>
