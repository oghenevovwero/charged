      ...
      <Container className="flex flex-col items-center bg-white text-black">
        <div className="mt-12 sm:mt-10 bg-white text-black">
          ...
          <div className="">
            ...
            these legal terms (referred to as the &apos;Legal Terms&apos;) that
            have been selected by you or your electric vehicle dealer (together
            known as the &apos;Services&apos;). You can reach us via phone at
            (954) 417-7696, email at help@gochargemenow.com These Legal Terms
            form a legally binding agreement between you, whether individually
            or on behalf of an entity (&apos;you&apos;), and Charge Me Now LLC,
            regarding your use of the Services. By accessing the Services, you
            acknowledge that you have read, understood, and agreed to comply
            with all these Legal Terms. IF YOU DISAGREE WITH ANY PART OF THESE
            LEGAL TERMS, YOU ARE NOT ALLOWED TO USE THE SERVICES, AND YOU MUST
            STOP USING THEM IMMEDIATELY. Additional terms and conditions or
            documents that may be published in the Services periodically are
            explicitly included here by reference. We reserve the right, at our
            sole discretion, to amend or modify these Legal Terms at any time
            and for any reason. Notification of any changes will be provided by
            updating the &apos;Last updated&apos; date of these Legal Terms. It
            is your responsibility to regularly review these Legal Terms to stay
            informed of any updates. By continuing to use the Services after the
            posting of any revised Legal Terms, you will be considered to have
            accepted the changes. All users who are minors in their jurisdiction
            (usually under the age of 18) must obtain permission from, and be
            directly supervised by, their parents or guardians to use the
            Services. If you are a minor, your parent or guardian must read and
            agree to these Legal Terms before you can use the Services.
          ...
          <div className="">
            ...
            the vehicle, and it&apos;s restricted to the individual designated
            on the subscription. Before roadside assistance Services are
            rendered, you must present personal identification, which must match
            the CMN account holder&apos;s information on record. New subscribers
            needing immediate assistance will incur a one-time fee of $125 for
            their initial request. The Roadside Assistance Service is not
            available for vehicles with existing issues. Additional charges may
            arise for waiting or standby time. Initially, Roadside Assistance
            Service offers Basic coverage of up to 10km, irrespective of the
          ...
          <div className="">
            ...
            your use of the Services. Charges may vary based on factors such as
            distance traveled, duration of use, and additional services
            requested.
          </div>
          <div className="my-4">
          ...
          <div className="mt-4">
            ...
            non-transferable license allowing you to utilize the application on
            a device running either the Apple iOS or Android operating systems,
            as appropriate, and in accordance with the usage regulations
          ...
          <div className="mt-4">
            ...
            support services for the App as outlined in the terms and conditions
            of this mobile application license included in these Legal Terms or
            as mandated under applicable law. You acknowledge that each App
            Distributor is not obligated to provide any maintenance and support
            services for the App.
          </div>
          <div className="mt-4">
            c. If the App fails to meet any applicable warranty, you may notify
            the relevant App Distributor, who, in accordance with its terms and
            policies, may refund the purchase price, if any, paid for the App.
            To the fullest extent permitted by applicable law, the App
            Distributor will have no other warranty obligations regarding the
            App.
          </div>
          ...
          <div className="mt-4">
            ...
            application license included in these Legal Terms. Each App
            ...
            mobile application license included in these Legal Terms against you
