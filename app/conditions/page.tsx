        ...
        <article className="mt-12 bg-white text-black sm:mt-10">
          ...
          <div>
            <p>
              ...
              Florida. We manage the mobile application CMN (Charge Me Now), as
              well as any other associated products and services connected to
              these legal terms (referred to as the &apos;Legal Terms&apos;)
              that have been selected by you or your electric vehicle dealer
              (together known as the &apos;Services&apos;). You can reach us via
              phone at (954) 417-7696, email at help@gochargemenow.com These
              Legal Terms form a legally binding agreement between you, whether
              individually or on behalf of an entity (&apos;you&apos;), and
              Charge Me Now LLC, regarding your use of the Services. By
              accessing the Services, you acknowledge that you have read,
              understood, and agreed to comply with all these Legal Terms. IF
              YOU DISAGREE WITH ANY PART OF THESE LEGAL TERMS, YOU ARE NOT
              ALLOWED TO USE THE SERVICES, AND YOU MUST STOP USING THEM
              IMMEDIATELY. Additional terms and conditions or documents that may
              be published in the Services periodically are explicitly included
              here by reference. We reserve the right, at our sole discretion,
              to amend or modify these Legal Terms at any time and for any
              reason. Notification of any changes will be provided by updating
              the &apos;Last updated&apos; date of these Legal Terms. It is your
              responsibility to regularly review these Legal Terms to stay
              informed of any updates. By continuing to use the Services after
              the posting of any revised Legal Terms, you will be considered to
              have accepted the changes. All users who are minors in their
              jurisdiction (usually under the age of 18) must obtain permission
              from, and be directly supervised by, their parents or guardians to
              use the Services. If you are a minor, your parent or guardian must
              read and agree to these Legal Terms before you can use the
              Services.
            </p>
            <header className="mb-2 mt-8 text-lg font-bold">
            ...
            <p className="mb-2 mt-8 text-lg font-bold">
            ...
            <p>Limited to Broward County area.</p>
            <header className="mb-2 mt-8 text-lg font-bold">
              Service Location:
            </header>
            <p>
            ...
            <header className="mb-2 mt-8 text-lg font-bold">Liability:</header>
            <p>
            ...
            <p>All bookings must be made through the designated App.</p>
            <header className="mb-2 mt-8 text-lg font-bold">
              Cancellation Policy:
            </header>
            <p>
          ...
          <p>
            ...
            security of your account and are solely responsible for any activity
          ...
          <header className="mb-2 mt-4 font-bold">1. Subscription</header>
          <ul>
            <li>
              ...
              eligible for our services. Please note that our services are not
              available if the vehicle is uninsured or inoperable before
              subscribing.
            </li>
            <p className="my-4">
              You have the option to enhance your Subscription coverage at any
              time, but certain conditions may apply:
            </p>
            <p className="mb-4 ml-8">
              <span className="text-3xl font-extrabold">. </span>
              Upgrading your Subscription is subject to the availability of the
              remaining Service.
            </p>
            <p className="mb-4 ml-8">
              <span className="text-3xl font-extrabold">. </span> Upgraded
              benefits take effect 48 hours after the upgrade is purchased.
            </p>
            <p className="mb-4 ml-8">
              <span className="text-3xl font-extrabold">. </span> Upgraded
              benefits do not extend to any existing issues with your vehicle.{" "}
            </p>
            <p className="mb-4 ml-8">
              <span className="text-3xl font-extrabold">. </span> Any additional
              charges associated with your Account will be your responsibility.
            </p>
            <li className="mb-4">
              b. Charge Me Now provides mobile EV charging services at
              designated locations or upon request.
            </li>
            <li className="mb-4">
              c. The availability of charging stations may vary depending on
              location and demand.
            </li>
            <li>
          ...
          <header className="mb-2 mt-4 font-bold">
          ...
          <ul>
            ...
            <li>
              ...
              assistance is only provided when you&apos;re physically present
              with the vehicle, and it&apos;s restricted to the individual
              designated on the subscription. Before roadside assistance
              Services are rendered, you must present personal identification,
              which must match the CMN account holder&apos;s information on
              record. New subscribers needing immediate assistance will incur a
              one-time fee of $125 for their initial request. The Roadside
              Assistance Service is not available for vehicles with existing
              issues. Additional charges may arise for waiting or standby time.
              Initially, Roadside Assistance Service offers Basic coverage of up
              to 10km, irrespective of the subscription level chosen by new
              subscribers.
            </li>
          </ul>
          <header className="mb-2 mt-4 font-bold">
          ...
          <ul>
            <li>
              ...
              your use of the Services. Charges may vary based on factors such
              as distance traveled, duration of use, and additional services
              requested.
            </li>
            <li className="my-4">
              b. Users are responsible for paying the fees associated with the
              use of our Service.
            </li>
            <li>
              c. Payment methods accepted will be clearly outlined on our
              platform
            </li>
          </ul>
          ...
          <p>
            ...
            important to note that you cannot cancel your subscription midway
            through the term.
          </p>

          <header className="mb-2 mt-4 font-bold">1. Payment Options:</header>
          <p>
          ...
          <p>
            ...
            original expiry date and any associated discounts. However, if you
            require Roadside Assistance during a lapsed subscription, you will
            need to pay a &quot;1 Time Request&quot; fee. Payment after 90 days
          ...
          <p className="mt-2">
            ...
            agree to the above terms and conditions regarding subscription
            renewal, payment options, lapsed subscriptions, subscription
            changes, and subscription pricing.
          </p>
          ...
          <p>
            ...
            notice for any reason, including maintenance, upgrades, or
          ...
          <p>
            ...
            Services or that may harm or compromise the security of our systems
            or other users.
          </p>
          ...
          <p>
            ...
            distribute any content from our Services without prior written
            permission.
          </p>
          ...
          <p>
            ...
            application (&quot;App&quot;). By downloading, installing, or using
          ...
          <ul>
            <li className="mt-4">
              a. The license granted to you for our App is restricted to a
              non-transferable license allowing you to utilize the application
              on a device running either the Apple iOS or Android operating
              systems, as appropriate, and in accordance with the usage
              regulations specified in the applicable App Distributor’s terms of
              service.
            </li>
            <li className="mt-4">
              b. We are responsible for providing any necessary maintenance and
              support services for the App as outlined in the terms and
              conditions of this mobile application license included in these
              Legal Terms or as mandated under applicable law. You acknowledge
              that each App Distributor is not obligated to provide any
              maintenance and support services for the App.
            </li>
            <li className="mt-4">
              c. If the App fails to meet any applicable warranty, you may
              notify the relevant App Distributor, who, in accordance with its
              terms and policies, may refund the purchase price, if any, paid
              for the App. To the fullest extent permitted by applicable law,
              the App Distributor will have no other warranty obligations
              regarding the App.
            </li>
          </ul>

          <header className="mt-4">d. You affirm and warrant that:</header>
          <ul>
            <li className="my-4 ml-8">
              <span className="text-3xl font-extrabold">. </span> You are not
              situated in a country subject to a US government embargo or
              designated by the US government as a &apos;terrorist
              supporting&apos; country.
            </li>
            <li className="ml-8">
              <span className="text-3xl font-extrabold">. </span> You are not
              included on any US government list of prohibited or restricted
              parties.
            </li>
            <li className="mt-4">
              e. You must adhere to applicable third-party agreements when using
              the App. For instance, if you use a VoIP application, you must not
              violate their wireless data service agreement when utilizing the
              App.
            </li>
            <li className="mt-4">
              f. You acknowledge and consent that the App Distributors are
              third-party beneficiaries of the terms and conditions in this
              mobile application license included in these Legal Terms. Each App
              Distributor will possess the right (and will be considered to have
              accepted the right) to enforce the terms and conditions in this
              mobile application license included in these Legal Terms against
          ...
          <ul>
            ...
            <li className="my-4">
              b. You may not sublicense, lease, rent, loan, distribute, or
          ...
          <header className="mb-2 mt-8 text-lg font-bold">13. Ownership</header>
          <p>
          ...
          <header className="mb-2 mt-8 text-lg font-bold">14. Updates:</header>
          <p>
          ...
          <header className="mb-2 mt-8 text-lg font-bold">23. Updates:</header>
          <p>
            Licensor may, from time to time, provide updates, modifications, or
            new versions of the App. You agree to promptly install and use such
            updates, modifications, or new versions as they become available.
          ...
          <ul>
            ...
            <li>
              b. By clicking &quot;I agree&quot; or by downloading, installing,
              or using the App, you acknowledge that you have read, understood,
