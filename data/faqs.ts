...
export const homePageQuestions: FAQ[] = [
  {
  ...
  },
  {
    ...
    answer:
      "We offer mobile charging units that come to your location for a faster, efficient charging experience",
  },
  {
    question: "Can I subscribe to a plan that suits my charging needs?",
    answer:
      "Yes, we offer flexible subscription plans tailored to your lifestyle. Choose from basic on-demand services to premium packages with exclusive benefits",
  },
  {
...
export const faqsPageQuestions: FAQ[] = [
  {
    question: "How does the on-demand mobile charging service work?",
    answer:
      "Our on-demand service allows you to request a mobile charging unit to your location. Simply use our app or contact our customer support, and we'll bring the charging station to you.",
